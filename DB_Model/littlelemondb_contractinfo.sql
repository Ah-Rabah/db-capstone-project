...
CREATE TABLE `contractinfo` (
  ...
  `location` varchar(50) NOT NULL DEFAULT 'SOKOTO',
  `StaffType` varchar(20) NOT NULL,
  PRIMARY KEY (`ContractID`),
  KEY `StaffID` (`StaffID`),
  CONSTRAINT `contractinfo_ibfk_1` FOREIGN KEY (`StaffID`) REFERENCES `staff` (`StaffID`)
...
-- Dump completed on 2023-10-09 17:00:23
