...
CREATE TABLE `table_orders` (
  ...
  KEY `WaiterID_fk_idx` (`WaiterID`),
  CONSTRAINT `TableID_fk` FOREIGN KEY (`TableID`) REFERENCES `table` (`TableID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `WaiterID_fk` FOREIGN KEY (`WaiterID`) REFERENCES `waiter` (`WaiterID`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2023-10-09 17:00:22
